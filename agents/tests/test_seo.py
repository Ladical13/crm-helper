...
# agents/tests is a package (it has __init__.py), so a bare `from conftest
# import ...` does not resolve — the fully-qualified path does.
from agents.tests.conftest import (BARE_HTML, FakeResponse,  # noqa: F401
                                   GOOD_HTML, SPA_HTML)
