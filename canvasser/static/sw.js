...
const CACHE = 'p1canvasser-v4';
const SHELL = [
  BASE + '/',
  BASE + '/static/style.css?v=4',
  BASE + '/static/app.js?v=4',
  ...
  BASE + '/static/vendor/leaflet.css?v=4',
  BASE + '/static/vendor/leaflet.js?v=4',
  BASE + '/static/vendor/MarkerCluster.css?v=4',
  BASE + '/static/vendor/leaflet.markercluster.js?v=4',
