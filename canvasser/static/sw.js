...
const CACHE = 'p1canvasser-v5';
const SHELL = [
  BASE + '/',
  BASE + '/static/style.css?v=5',
  BASE + '/static/app.js?v=5',
  ...
  BASE + '/static/vendor/leaflet.css?v=5',
  BASE + '/static/vendor/leaflet.js?v=5',
  BASE + '/static/vendor/MarkerCluster.css?v=5',
  BASE + '/static/vendor/leaflet.markercluster.js?v=5',
