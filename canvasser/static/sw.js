...
const CACHE = 'p1canvasser-v6';
const SHELL = [
  BASE + '/',
  BASE + '/static/style.css?v=6',
  BASE + '/static/app.js?v=6',
  ...
  BASE + '/static/vendor/leaflet.css?v=6',
  BASE + '/static/vendor/leaflet.js?v=6',
  BASE + '/static/vendor/MarkerCluster.css?v=6',
  BASE + '/static/vendor/leaflet.markercluster.js?v=6',
