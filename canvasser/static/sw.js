...
const CACHE = 'p1canvasser-v7';
const SHELL = [
  BASE + '/',
  BASE + '/static/style.css?v=7',
  BASE + '/static/app.js?v=7',
  ...
  BASE + '/static/vendor/leaflet.css?v=7',
  BASE + '/static/vendor/leaflet.js?v=7',
  BASE + '/static/vendor/MarkerCluster.css?v=7',
  BASE + '/static/vendor/leaflet.markercluster.js?v=7',
