...
const SHELL = [
  ...
  BASE + '/static/vendor/leaflet.css?v=1',
  BASE + '/static/vendor/leaflet.js?v=1',
  BASE + '/static/vendor/MarkerCluster.css?v=1',
  BASE + '/static/vendor/leaflet.markercluster.js?v=1',
