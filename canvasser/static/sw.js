...
const CACHE = 'p1canvasser-v8';
const SHELL = [
  BASE + '/',
  BASE + '/static/style.css?v=8',
  BASE + '/static/app.js?v=8',
  ...
  BASE + '/static/vendor/leaflet.css?v=8',
  BASE + '/static/vendor/leaflet.js?v=8',
  BASE + '/static/vendor/MarkerCluster.css?v=8',
  BASE + '/static/vendor/leaflet.markercluster.js?v=8',
